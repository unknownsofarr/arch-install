...
ln -sf $BASE_FILE_PATH'/'$ZONE'/'$TIMEZONE /etc/localtime
hwclock --systohc
clear
echo '[^_^] Timezone setup complete...'

# setting up local
echo '[^_^] Settingup locale...'
